...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId,
        [Description("The datetime of the booking")] DateTime dt
    )
    {
    ...
    [KernelFunction]
    [Description("Get bookings for a specific hotel with missing hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get bookings for a specific hotel with multiple hotel rooms.")]
